...
I am a post-doc at the Faculty of Information Sciences at the University of Toronto, Canada. My [academic research](https://rohanalexander.com/academic.html) answers questions in social sciences, such as: are our politicians actually representing us, do elections matter, and how can we make political polling better. To do this I build, clean, maintain, and share datasets in a reproducible way, and then using quantitative methods, such as text analysis, machine learning, and Bayesian hierarchical models, to analyse them.
