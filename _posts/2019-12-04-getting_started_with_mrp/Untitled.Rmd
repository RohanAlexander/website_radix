...
author: "Rohan Alexander <br> University of Toronto"
date: "MRP Reading Group <br> 18 December 2019"
...
knitr::include_graphics("inputs/figures/github.png") 
```
...
knitr::include_graphics("inputs/figures/states.png") 
```
...
```{r  out.width = "70%", fig.align="center", echo=F}
knitr::include_graphics("inputs/figures/demographics.png") 
```
...
```{r  out.width = "70%", fig.align="center", echo=F}
knitr::include_graphics("inputs/figures/electoral_college.png") 
```
...
```{r initial_model_simulate_datda, message=FALSE,}
...
head(example_poll) # Displays the first few rows
```
...
```{r initial_model_simulate_datad, message=FALSE,}
...
```{r initial_model_post_stratify_age_sex_specific, eval = F}
...
```{r initial_model_post_stratify_age_sex_specificf, echo = F}
# Here we are making predictions using our model with some new data from the 
# census, and we saving the results of those predictions by adding a new column 
# to the census_data dataset called 'estimate'.
census_data$estimate <- 
...
```{r brms_model_analyse_example_pollingd}
summary(model)
```
---
...
```{r brms_model_post_stratify_age_sex_specific, eval = F}
...
```{r brms_model_post_stratify_age_sex_sdpecific, echo = F}
post_stratified_estimates <- 
  model %>% 
  tidybayes::add_predicted_draws(newdata = census_data) %>% 
  rename(alp_predict = .prediction) %>% 
...
```{r brms_model_analysed_extendedd}
...
```{r brms_model_analyse_extendaedd}
...
```{r brms_model_analyse_extendesdd}
...
```{r brms_model_analyse_extednded_state_counts}
example_poll %>% 
  count(state)
```
...
```{r  out.width = "60%", fig.align="center", echo=F}
knitr::include_graphics("inputs/figures/tablebuilder.png") 
```
...
```{r  out.width = "60%", fig.align="center", echo=F}
knitr::include_graphics("inputs/figures/census_select_type.png") 
```
...
```{r  out.width = "60%", fig.align="center", echo=F}
knitr::include_graphics("inputs/figures/census_type.png") 
```
...
```{r  out.width = "60%", fig.align="center", echo=F}
knitr::include_graphics("inputs/figures/census_cols.png") 
```
...
```{r  out.width = "60%", fig.align="center", echo=F}
knitr::include_graphics("inputs/figures/census_rows.png") 
```
...
```{r  out.width = "60%", fig.align="center", echo=F}
knitr::include_graphics("inputs/figures/census_download.png") 
```
